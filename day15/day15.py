...
resources = {
    "water": {"friendly_name": "Water", "unit": "ml", "amount": 300},
    "milk": {"friendly_name": "Milk", "unit": "ml", "amount": 200},
    "coffee": {"friendly_name": "Coffee beans", "unit": "g", "amount": 100},
    "money": {"friendly_name": "Money", "unit": "dollars", "amount": 0},
}
...
def sufficient_resources(drink: str) -> bool:
    if resources["water"]["amount"] < MENU[drink]["ingredients"]["water"]:
        ...
        drink != "espresso"
        and resources["milk"]["amount"] < MENU[drink]["ingredients"]["milk"]
    ):
